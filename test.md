...
| Claude | `claude -p "First H2 in core/styles/interaction-design.md?"` | `Interaction Design` |
...
| Codex | `codex exec "First H2 in core/styles/interaction-design.md, no preamble"` | `Interaction Design` |
...
| Gemini | `gemini -p "First H2 in core/styles/interaction-design.md?"` | `Interaction Design` |
