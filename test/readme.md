...
`paths` creates a workspace decoy at `core/standards/interaction-design.md`. It asks for `profile:core/standards/interaction-design.md` and fails if the answer resolves the decoy instead of the profile file whose first H2 is `Interaction Design`.
...
| Claude | `claude -p "First H2 in profile:core/standards/interaction-design.md?"` | `Interaction Design` |
...
| Codex | `codex exec "First H2 in profile:core/standards/interaction-design.md, no preamble"` | `Interaction Design` |
...
| Gemini | `gemini -p "First H2 in profile:core/standards/interaction-design.md?"` | `Interaction Design` |
